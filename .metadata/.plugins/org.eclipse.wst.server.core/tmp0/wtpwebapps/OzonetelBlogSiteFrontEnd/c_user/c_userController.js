myApp.controller("c_userController", function($scope, $http, $rootScope, $location,$cookieStore,$route)
{
	...
	$scope.login = function()
	{
		...
		$http.post('http://localhost:8081/OzonetelBlogSiteMiddelware/checkLogin', $scope.user)
	...
	$scope.register = function()
	{
		...
		$http.post('http://localhost:8081/OzonetelBlogSiteMiddelware/registerUser', $scope.user)
		.then(function(response)
				{
